                        ...
                        <form method="post" action="{{url('contracts')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="transaction" placeholder="Например: 50000">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="servicecost">Стоимость услуг:</label>
                                    <input type="text" class="form-control" name="servicecost" placeholder="Например: 5000">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="dealdate">Дата сделки:</label>
                                    <input type="date" class="form-control" name="dealdate">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="dealarea">Площадь сделки:</label>
                                    <input type="text" class="form-control" name="dealarea" placeholder="Например: 250">
                                </div>
                                <div class="form-group col-md-4">
